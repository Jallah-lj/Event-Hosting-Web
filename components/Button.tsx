...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-liberia-red text-white hover:bg-red-800 focus:ring-red-500 shadow-md",
    secondary: "bg-liberia-blue text-white hover:bg-blue-900 focus:ring-blue-500 shadow-md",
    outline: "border-2 border-liberia-blue text-liberia-blue hover:bg-blue-50 focus:ring-blue-500",
